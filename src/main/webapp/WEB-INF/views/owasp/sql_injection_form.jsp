        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    ...
                    <form id="frm" action="/sqlinjct" method="post">
                        <div class="panel-body">
                            <div class="col-sm-6">
                                <div class="form-group input-group">
                                    <span class="input-group-addon">ID</span>
                                    <input type="text" class="form-control" id="userId" name="userId" placeholder="Login ID">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <input type="url" class="form-control" id="moveUrl" name="moveUrl" value="" placeholder="Search or scan a URL">
